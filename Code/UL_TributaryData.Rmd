...
loading_AllWatersheds_annual <- loading_AllWatersheds %>%
  ...
  summarise(Flow.cfs = sum(Flow.cfs), 
            load.TN.tonmo = sum(load.TN.tonmo), 
            load.TDN.tonmo = sum(load.TDN.tonmo), 
            load.TP.tonmo = sum(load.TP.tonmo), 
            load.TDP.tonmo = sum(load.TDP.tonmo), 
            load.TOC.tonmo = sum(load.TOC.tonmo), 
            load.DOC.tonmo = sum(load.DOC.tonmo))
```
