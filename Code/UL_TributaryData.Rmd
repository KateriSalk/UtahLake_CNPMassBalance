...
# REVISIT move this down
ggplot(dmr_load, aes(x = as.factor(Month), y = TP.tonmo)) +
  geom_boxplot() +
  facet_wrap(vars(NPDES.Name)) +
  scale_y_log10()
...
ggplot(trib_fac_sites_intersect_downstream_early, 
       aes(x = ActivityStartDate, y = TN, shape = SiteType,
...
# TDN
ggplot(trib_fac_sites_intersect_downstream_early, 
       aes(x = ActivityStartDate, y = TDN, shape = SiteType,
           color = OrganizationIdentifier)) +
  geom_point(alpha = 0.7, size = 2) +
  facet_wrap(vars(WS_Name), ncol = 3) +
  scale_y_log10() +
...
# TP
ggplot(trib_fac_sites_intersect_downstream_early, 
       aes(x = ActivityStartDate, y = TP, shape = SiteType,
           color = OrganizationIdentifier)) +
  geom_point(alpha = 0.7, size = 2) +
  facet_wrap(vars(WS_Name), ncol = 3) +
  scale_y_log10() +
...
# TDP
ggplot(trib_fac_sites_intersect_downstream_early, 
       aes(x = ActivityStartDate, y = TDP, shape = SiteType,
           color = OrganizationIdentifier)) +
  geom_point(alpha = 0.7, size = 2) +
  facet_wrap(vars(WS_Name), ncol = 3) +
  scale_y_log10() +
...
# TOC
ggplot(trib_fac_sites_intersect_downstream_early, 
       aes(x = ActivityStartDate, y = TOC, shape = SiteType,
           color = OrganizationIdentifier)) +
  geom_point(alpha = 0.7, size = 2) +
  facet_wrap(vars(WS_Name), ncol = 3) +
  scale_y_log10() +
...
# DOC
ggplot(trib_fac_sites_intersect_downstream_early, 
       aes(x = ActivityStartDate, y = DOC, shape = SiteType,
           color = OrganizationIdentifier)) +
  geom_point(alpha = 0.7, size = 2) +
  facet_wrap(vars(WS_Name), ncol = 3) +
  scale_y_log10() +
...
Calculate monthly loading from WWTP
```{r}
