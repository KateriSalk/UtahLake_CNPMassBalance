...
dmr_Payson_load <- dmr_Payson %>%
  mutate(NPDES.ID = NPDES.ID, 
         ...
         TP.tonmo = `TP.mg/L`*Effluent.Flow.MGD,
         PO4.tonmo = `Ortho.P.mg/L`*Effluent.Flow.MGD,
         TKN.tonmo = `TKN.mg/L`*Effluent.Flow.MGD,
         NH3.tonmo = NA,
         NO3.tonmo = `Nitrate.mg/L`*Effluent.Flow.MGD,
