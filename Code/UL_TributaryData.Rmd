...
# calculate load from 6100/6096 with WFWQC data 
# take average of 6100 and 6096 (equivalent sites)
...
# calculate load from 6100 with DWQ data 
loading_HobbleCreek_UTAHDWQloads <- loading_HobbleCreek_initial %>%
  filter(MonitoringLocationIdentifier %in% c("UTAHDWQ_WQX-4996100"))
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Lehi Spring Creek"),
  ...
  geom_boxplot(position = position_dodge(preserve = "single"), alpha = 0.8) +
  geom_hline(yintercept = 0.2, lty = 2, color = "#f27162") +
  geom_hline(yintercept = 0.7, lty = 2, color = "#62197d") +
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TN (mg/L)", fill = "Site", title = "Lehi Spring Creek") +
  scale_fill_manual(values = c("#f27162", "#62197d")) +
  theme(legend.position = "top")
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "American Fork River"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TN (mg/L)", fill = "Site", title = "American Fork River") +
  scale_fill_manual(values = c("#f27162", "#62197d")) +
  theme(legend.position = "top")
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Lindon Drain"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TN (mg/L)", fill = "Site", title = "Lindon Drain") +
  scale_fill_manual(values = c("#f27162", "#62197d")) +
  theme(legend.position = "top")
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Provo River"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TN (mg/L)", fill = "Site", title = "Provo River") +
  scale_fill_manual(values = c("#f27162", "#62197d")) +
  theme(legend.position = "top")
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Hobble Creek"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TN (mg/L)", fill = "Site", title = "Hobble Creek") +
  scale_fill_manual(values = c("#fc9d6f",  "#8a2880", "#3b1165")) +
  theme(legend.position = "top") +
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Spanish Fork River"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  ylim(0, 2) +
  labs(x = "Month", y = "TN (mg/L)", fill = "Site", title = "Spanish Fork River") +
  scale_fill_manual(values = c("#f27162", "#62197d")) +
  theme(legend.position = "top")
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "4000 South Drain Spanish Fork"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TN (mg/L)", fill = "Site", title = "4000 South Drain Spanish Fork") +
  scale_fill_manual(values = c("#f27162", "#62197d")) +
  theme(legend.position = "top")
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Lehi Spring Creek"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TP (mg/L)", fill = "Site", title = "Lehi Spring Creek") +
  scale_fill_manual(values = c("#f27162", "#62197d")) +
  scale_color_manual(values = c("black", "gray"), guide = "none") +
  theme(legend.position = "top")
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "American Fork River"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TP (mg/L)", fill = "Site", title = "American Fork River") +
  scale_fill_manual(values = c("#f27162", "#62197d")) +
  scale_color_manual(values = c("black", "gray"), guide = "none") +
  theme(legend.position = "top")
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Lindon Drain"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TP (mg/L)", fill = "Site", title = "Lindon Drain") +
  scale_fill_manual(values = c("#f27162", "#62197d")) +
  scale_color_manual(values = c("black", "gray"), guide = "none") +
  theme(legend.position = "top")
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Provo River"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TP (mg/L)", fill = "Site", title = "Provo River") +
  scale_fill_manual(values = c("#f27162", "#62197d")) +
  scale_color_manual(values = c("black", "gray"), guide = "none") +
  theme(legend.position = "top")
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Hobble Creek"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TP (mg/L)", fill = "Site", title = "Hobble Creek") +
  scale_fill_manual(values = c("#fc9d6f",  "#8a2880", "#3b1165")) +
  scale_color_manual(values = c("black", "gray"), guide = "none") +
  theme(legend.position = "top")+
  guides(fill = guide_legend(nrow = 2))
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Spanish Fork River"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TP (mg/L)", fill = "Site", title = "Spanish Fork River") +
  scale_fill_manual(values = c("#f27162", "#62197d")) +
  scale_color_manual(values = c("black", "gray"), guide = "none") +
  theme(legend.position = "top")
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "4000 South Drain Spanish Fork"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TP (mg/L)", fill = "Site", title = "4000 South Drain Spanish Fork") +
  scale_fill_manual(values = c("#f27162", "#62197d")) +
  theme(legend.position = "top")
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Timp SSD"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TN (mg/L)", fill = "Site", title = "Timp SSD") +
  scale_fill_manual(values = c("#fc9d6f", "#db4a69", "#62197d")) +
  theme(legend.position = "top") +
  guides(fill = guide_legend(nrow = 2))
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Powell Slough Major"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TN (mg/L)", fill = "Site", title = "Powell Slough Major") +
  scale_fill_manual(values = c("#fc9d6f", "#db4a69", "#62197d")) +
  theme(legend.position = "top") +
  guides(fill = guide_legend(nrow = 2))
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Mill Race"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TN (mg/L)", fill = "Site", title = "Mill Race") +
  scale_fill_manual(values = c("#fc9d6f", "#db4a69", "#8a2880", "#3b1165")) +
  theme(legend.position = "top") +
  guides(fill = guide_legend(nrow = 2))
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Spring Creek - Springville"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TN (mg/L)", fill = "Site", title = "Spring Creek - Springville") +
  scale_fill_manual(values = c("#f27162", "#62197d")) +
  theme(legend.position = "top")
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Dry Creek - Spanish Fork"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TN (mg/L)", fill = "Site", title = "Dry Creek - Spanish Fork") +
  scale_fill_manual(values = c("#fc9d6f", "#f27162", "#db4a69", "#62197d")) +
  theme(legend.position = "top") +
  guides(fill = guide_legend(nrow = 2))
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Benjamin Slough"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  ylim(0, 2) +
  labs(x = "Month", y = "TN (mg/L)", fill = "Site", title = "Benjamin Slough") +
  scale_fill_manual(values = c("#f27162", "#62197d")) +
  theme(legend.position = "top")
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Timp SSD"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TP (mg/L)", fill = "Site", title = "Timp SSD") +
  scale_fill_manual(values = c("#fc9d6f", "#db4a69", "#62197d")) +
  theme(legend.position = "top") +
  guides(fill = guide_legend(nrow = 2))
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Powell Slough Major"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TP (mg/L)", fill = "Site", title = "Powell Slough Major") +
  scale_fill_manual(values = c("#fc9d6f", "#db4a69", "#62197d")) +
  theme(legend.position = "top") +
  guides(fill = guide_legend(nrow = 2))
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Mill Race"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TP (mg/L)", fill = "Site", title = "Mill Race") +
  scale_fill_manual(values = c("#fc9d6f", "#db4a69", "#8a2880", "#3b1165")) +
  theme(legend.position = "top") +
  guides(fill = guide_legend(nrow = 2))
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Spring Creek - Springville"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TP (mg/L)", fill = "Site", title = "Spring Creek - Springville") +
  scale_fill_manual(values = c("#f27162", "#62197d")) +
  theme(legend.position = "top")
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Dry Creek - Spanish Fork"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  labs(x = "Month", y = "TP (mg/L)", fill = "Site", title = "Dry Creek - Spanish Fork") +
  scale_fill_manual(values = c("#fc9d6f", "#f27162", "#db4a69", "#62197d")) +
  theme(legend.position = "top") +
  guides(fill = guide_legend(nrow = 2))
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Benjamin Slough"),
  ...
  stat_summary(fun.data = give.n, geom = "text", size = 3,
                  position = position_dodge(width = 0.75)) +
  ylim(0, 2) +
  labs(x = "Month", y = "TP (mg/L)", fill = "Site", title = "Benjamin Slough") +
  scale_fill_manual(values = c("#f27162", "#62197d")) +
  theme(legend.position = "top")
