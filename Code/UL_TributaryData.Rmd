...
ggplot(wshds) +
  geom_sf(aes(fill = Monitored_)) +
  geom_sf(data = trib_fac_sites_downstream_sf, aes(color = OrganizationIdentifier)) +
  #geom_point(aes(x = 39.94447, y = -111.7749)) +
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
# TN
ggplot(trib_fac_sites_intersect_downstream, aes(x = ActivityStartDate, y = load.TN.kgd, shape = SiteType,
                                                color = OrganizationIdentifier)) +
  geom_point(alpha = 0.7, size = 2) +
  facet_wrap(vars(WS_Name), ncol = 3) +
  scale_y_log10() +
...
# TDN
ggplot(trib_fac_sites_intersect_downstream, aes(x = ActivityStartDate, y = load.TDN.kgd, shape = SiteType,
                                                color = OrganizationIdentifier)) +
  geom_point(alpha = 0.7, size = 2) +
  facet_wrap(vars(WS_Name), ncol = 3) +
  scale_y_log10() +
...
# TP
ggplot(trib_fac_sites_intersect_downstream, aes(x = ActivityStartDate, y = load.TP.kgd, shape = SiteType,
                                                color = OrganizationIdentifier)) +
  geom_point(alpha = 0.7, size = 2) +
  facet_wrap(vars(WS_Name), ncol = 3) +
  scale_y_log10() +
...
# TDP
ggplot(trib_fac_sites_intersect_downstream, aes(x = ActivityStartDate, y = load.TDP.kgd, shape = SiteType,
                                                color = OrganizationIdentifier)) +
  geom_point(alpha = 0.7, size = 2) +
  facet_wrap(vars(WS_Name), ncol = 3) +
  scale_y_log10() +
...
# TOC
ggplot(trib_fac_sites_intersect_downstream, aes(x = ActivityStartDate, y = load.TOC.kgd, shape = SiteType,
                                                color = OrganizationIdentifier)) +
  geom_point(alpha = 0.7, size = 2) +
  facet_wrap(vars(WS_Name), ncol = 3) +
  scale_y_log10() +
...
# DOC
ggplot(trib_fac_sites_intersect_downstream, aes(x = ActivityStartDate, y = load.DOC.kgd, shape = SiteType,
                                                color = OrganizationIdentifier)) +
  geom_point(alpha = 0.7, size = 2) +
  facet_wrap(vars(WS_Name), ncol = 3) +
  scale_y_log10() +
...
```{r, include = FALSE}
loading_PowellSloughMajor <- trib_fac_sites_intersect_downstream %>%
  ungroup() %>%
...
4996536 represents the sum total of loading from the watershed. 4996540 and 4996536 should be added together to represent total flow.

```{r, include = FALSE}
loading_MillRace <- trib_fac_sites_intersect_downstream %>%
  ungroup() %>%
...
### Monthly load across watersheds
