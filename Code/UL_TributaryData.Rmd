...
ul_level <- read.xlsx("./Data/Raw/Copy of ULDB_Stage_Vol_SA_V3(sd-JLM).xlsm", 
...
dmr_updated_Payson <- dmr_Payson %>%
  ...
  select(npdes_id, NPES_Name, Year, Month, Flow.MGD, NH3.mgL, TP.mgL, 
         PO4.mgL, TKN.mgL, Flow.acftmo, TP.tonmo, PO4.tonmo, TKN.tonmo)
...
dmr_updated_wide$TKN.tonmo <-  round(dmr_updated_wide$TKN.tonmo, digits = 2)
...
### DMR Flow, concentration, and load
REVISIT
```{r}
ggplot(dmr_flow, aes(x = Month, y = Flow.acftmo)) +
  geom_line() +
...
ggplot(subset(dmr_concentration, !is.na(WS_Name)), aes(x = Date, y = TP)) +
  geom_point() +
  scale_y_log10() +
  labs(y = expression("TP ("*mu*"g/L)"), x = "") +
  facet_wrap(vars(WS_Name, NPDES.Name), nrow = 2,  
             labeller = label_wrap_gen(width = 20, multi_line = TRUE))
#ggsave("./Code/Output/DMR_TPconc_TimeSeries.jpg", width = 8, height = 5)

ggplot(subset(dmr_concentration, !is.na(WS_Name)), aes(x = Date, y = TKN)) +
  geom_point() +
  scale_y_log10() +
  labs(y = expression("TKN ("*mu*"g/L)"), x = "") +
  facet_wrap(vars(WS_Name, NPDES.Name), nrow = 2,  
             labeller = label_wrap_gen(width = 20, multi_line = TRUE))
#ggsave("./Code/Output/DMR_TKNconc_TimeSeries.jpg", width = 8, height = 5)

ggplot(subset(dmr_concentration, !is.na(WS_Name)), aes(x = Date, y = PO4)) +
  geom_point() +
  scale_y_log10() +
  labs(y = expression("Orthophosphate ("*mu*"g/L)"), x = "") +
  facet_wrap(vars(WS_Name, NPDES.Name), nrow = 2,  
             labeller = label_wrap_gen(width = 20, multi_line = TRUE))
#ggsave("./Code/Output/DMR_PO4conc_TimeSeries.jpg", width = 8, height = 5)

ggplot(subset(dmr_concentration, !is.na(WS_Name)), aes(x = as.factor(Month), y = TP)) +
  geom_boxplot() +
  scale_y_log10() +
  labs(y = expression("TP ("*mu*"g/L)"), x = "Month") +
  facet_wrap(vars(WS_Name, NPDES.Name), nrow = 2,  
             labeller = label_wrap_gen(width = 20, multi_line = TRUE))
#ggsave("./Code/Output/DMR_TPconc_Monthly.jpg", width = 8, height = 5)

ggplot(subset(dmr_concentration, !is.na(WS_Name)), aes(x = as.factor(Year), y = TP)) +
  geom_boxplot() +
  scale_y_log10() +
  labs(y = expression("TP ("*mu*"g/L)"), x = "Year") +
  facet_wrap(vars(WS_Name, NPDES.Name), nrow = 2,  
             labeller = label_wrap_gen(width = 20, multi_line = TRUE))
#ggsave("./Code/Output/DMR_TPconc_annual.jpg", width = 8, height = 5)

ggplot(subset(dmr_concentration, !is.na(WS_Name)), aes(x = as.factor(Month), y = TKN)) +
  geom_boxplot() +
  scale_y_log10() +
  labs(y = expression("TKN ("*mu*"g/L)"), x = "Month") +
  facet_wrap(vars(WS_Name, NPDES.Name), nrow = 2,  
             labeller = label_wrap_gen(width = 20, multi_line = TRUE))
#ggsave("./Code/Output/DMR_TKNconc_Monthly.jpg", width = 8, height = 5)

ggplot(subset(dmr_concentration, !is.na(WS_Name)), aes(x = as.factor(Month), y = PO4)) +
  geom_boxplot() +
  scale_y_log10() +
  labs(y = expression("Orthophosphate ("*mu*"g/L)"), x = "Month") +
  facet_wrap(vars(WS_Name, NPDES.Name), nrow = 2,  
             labeller = label_wrap_gen(width = 20, multi_line = TRUE))
#ggsave("./Code/Output/DMR_PO4conc_Monthly.jpg", width = 8, height = 5)

ggplot(subset(dmr_load, 
              !(NPDES.Name %in% c("MCWANE DUCTILE-UTAH", "Mona Wastewater Treatment Plant", "PAYSON POWER PROJECT"))),
       aes(x = as.factor(Month), y = TP.tonmo)) +
  geom_boxplot() +
  scale_y_log10() +
...
ggplot(subset(dmr_load, 
              !(NPDES.Name %in% c("MCWANE DUCTILE-UTAH", "Mona Wastewater Treatment Plant", "PAYSON POWER PROJECT", "PacifiCorp Energy"))),
       aes(x = as.factor(Month), y = TKN.tonmo)) +
  geom_boxplot() +
  scale_y_log10() +
  labs(y = "TKN load (metric ton/mo)", x = "Month") +
  facet_wrap(vars(NPDES.Name), nrow = 2,  
             labeller = label_wrap_gen(width = 20, multi_line = TRUE))
#ggsave("./Code/Output/DMR_TKNload_Monthly.jpg", width = 8, height = 5)

ggplot(subset(dmr_load, 
              !(NPDES.Name %in% c("MCWANE DUCTILE-UTAH", "Mona Wastewater Treatment Plant", "PAYSON POWER PROJECT", "PacifiCorp Energy"))),
       aes(x = as.factor(Month), y = PO4.tonmo)) +
  geom_boxplot() +
  scale_y_log10() +
...
#ggsave("./Code/Output/load_Tickville.jpg", height = 6, width = 7)
```
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
#ggsave("./Code/Output/load_DrySaratoga.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
#ggsave("./Code/Output/load_Lehi.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
#ggsave("./Code/Output/load_American.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
#ggsave("./Code/Output/load_Timp.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
#ggsave("./Code/Output/load_Lindon.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
#ggsave("./Code/Output/load_Powell.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
#ggsave("./Code/Output/load_Provo.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
#ggsave("./Code/Output/load_Mill.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
# ggsave("./Code/Output/load_Spring.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
# ggsave("./Code/Output/load_Hobble.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
#ggsave("./Code/Output/load_DrySpanish.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
#ggsave("./Code/Output/load_Spanish.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
#ggsave("./Code/Output/load_4000.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
#ggsave("./Code/Output/load_Benjamin.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
#ggsave("./Code/Output/load_Currant.jpg", height = 6, width = 7)
...
loading_LindonDrain_dmr <- dmr_load %>%
  ...
  mutate(WS_Name = "Lindon Drain", 
         ...
         Flow.acftmo.dmr = case_when(Month %in% c(1, 3, 5, 7, 8, 10, 12) ~ Flow.cfs.dmr * 86400 * 31/43559.9,
                                 Month %in% c(4, 6, 9, 11) ~ Flow.cfs.dmr * 86400 * 30/43559.9,
                                 Month %in% c(2) ~ Flow.cfs.dmr * 86400 * 28/43559.9),
...
# add average monthly DMR values to DWQ values
  ...
  select(-NPDES.Name, -Flow.cfs.dmr, -Flow.acftmo.dmr, -load.TP.tonmo.dmr)
...
loading_BenjaminSlough_dmr <- dmr_updated_wide %>%
  ...
  select(NPES_Name, Month, Flow.acftmo, load.TP.tonmo, load.TDP.tonmo, load.TKN.tonmo, WS_Name)
...
loading_AllWatersheds_dmr2_annual <- loading_AllWatersheds_dmr_annual %>%
  ...
  summarise(Flow.acftyr = sum(Flow.acftyr), 
            ...
            load.TKN.tonyr = sum(load.TKN.tonyr)) %>%
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Tickville Wash"),
  ...
  geom_boxplot(position = position_dodge(preserve = "single"), alpha = 0.8) +
  stat_summary(fun.data = give.n, geom = "text", size = 3) +
  labs(x = "Month", y = expression("TN ("*mu*"g/L)"), fill = "Site") +
  scale_fill_manual(values = c("#f27162")) +
  scale_color_manual(values = c("black", "gray"), guide = "none") +
  theme(legend.position = "none", 
        axis.title.x = element_blank(), axis.text.x = element_blank())
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Tickville Wash"),
  ...
  geom_boxplot(position = position_dodge(preserve = "single"), alpha = 0.8) +
  stat_summary(fun.data = give.n, geom = "text", size = 3) +
  labs(x = "Month", y = expression("TDN ("*mu*"g/L)"), fill = "Site") +
  scale_fill_manual(values = c("#f27162")) +
  scale_color_manual(values = c("black", "gray"), guide = "none") +
  theme(legend.position = "none", 
        axis.title.x = element_blank(), axis.text.x = element_blank())
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Tickville Wash"),
  ...
  geom_boxplot(position = position_dodge(preserve = "single"), alpha = 0.8) +
  stat_summary(fun.data = give.n, geom = "text", size = 3) +
  labs(x = "Month", y = expression("TP ("*mu*"g/L)"), fill = "Site") +
  scale_fill_manual(values = c("#f27162")) +
  scale_color_manual(values = c("black", "gray"), guide = "none") +
  theme(legend.position = "none", 
        axis.title.x = element_blank(), axis.text.x = element_blank())
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Tickville Wash"),
  ...
  geom_boxplot(position = position_dodge(preserve = "single"), alpha = 0.8) +
  stat_summary(fun.data = give.n, geom = "text", size = 3) +
  labs(x = "Month", y = expression("TDP ("*mu*"g/L)"), fill = "Site") +
  scale_fill_manual(values = c("#f27162")) +
  scale_color_manual(values = c("black", "gray"), guide = "none") +
  theme(legend.position = "none", 
        axis.title.x = element_blank(), axis.text.x = element_blank())
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Tickville Wash"),
  ...
  geom_boxplot(position = position_dodge(preserve = "single"), alpha = 0.8) +
  stat_summary(fun.data = give.n, geom = "text", size = 3) +
  labs(x = "Month", y = expression("TOC ("*mu*"g/L)"), fill = "Site") +
  scale_fill_manual(values = c("#f27162")) +
  scale_color_manual(values = c("black", "gray"), guide = "none") +
  theme(legend.position = "none")
...
ggplot(subset(trib_fac_sites_intersect_downstream, WS_Name == "Tickville Wash"),
  ...
  geom_boxplot(position = position_dodge(preserve = "single"), alpha = 0.8) +
  stat_summary(fun.data = give.n, geom = "text", size = 3) +
  labs(x = "Month", y = expression("DOC ("*mu*"g/L)"), fill = "Site") +
  scale_fill_manual(values = c("#f27162")) +
  scale_color_manual(values = c("black", "gray"), guide = "none") +
  theme(legend.position = "none")
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
ggsave("./Code/Output/concentration_Tickville.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
ggsave("./Code/Output/concentration_DrySaratoga.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
ggsave("./Code/Output/concentration_Lehi.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
ggsave("./Code/Output/concentration_American.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
ggsave("./Code/Output/concentration_Timp.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
ggsave("./Code/Output/concentration_Lindon.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
ggsave("./Code/Output/concentration_Powell.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
ggsave("./Code/Output/concentration_Provo.jpg", height = 6, width = 7)
...
legend <- get_legend(TN + guides(fill = guide_legend(nrow = 2)) + 
                     theme(legend.position = "top"))
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
ggsave("./Code/Output/concentration_Mill.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
ggsave("./Code/Output/concentration_Spring.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
ggsave("./Code/Output/concentration_Hobble.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
ggsave("./Code/Output/concentration_DrySpanish.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
ggsave("./Code/Output/concentration_Spanish.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
ggsave("./Code/Output/concentration_4000.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
ggsave("./Code/Output/concentration_Benjamin.jpg", height = 6, width = 7)
...
plot_grid(legend, CNP, ncol = 1, rel_heights = c(0.1, 1))
ggsave("./Code/Output/concentration_Currant.jpg", height = 6, width = 7)
