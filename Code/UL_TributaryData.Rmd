...
Sample type of "11" indicates a site was not sampled. Sample type of "10" indicates there was no flow. The latter should appear in the flow data as a zero; this was verified by inspecting the two datasets.

REVISIT: what to do about unsampled sites? 
```{r, include = FALSE}
...
REVISIT should I use average area of Utah Lake to calculate areal rates? 
