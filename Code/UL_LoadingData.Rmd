...
flow_total$Source <- factor(flow_total$Source, 
         levels = c("Streams & Runoff", "Precipitation", "Groundwater",
                    "Jordan River", "Evaporation"))
...
monitored_loading_monthly_total
...
ggplot(flow_total, aes(x = Source, y = Flow.acftyr, fill = Source)) +
  ...
  geom_text(aes(label = paste0(Flow.percent, "%")), 
...
#ggsave(file = "./Code/Output/hydrologyload_total_annual.jpg", width = 5, height = 4)
