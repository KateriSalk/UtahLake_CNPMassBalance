...
trib_data=subset(trib_data, CharacteristicName %in% c("Phosphate-phosphorus","Nitrogen","Flow","Total dissolved solids"))
...
trib_data=within(trib_data, {
	...
	param_name[CharacteristicName=="Total dissolved solids"]="Total dissolved solids"
...
table(is.na(trib_data$ResultMeasureValue)) # Should be all FALSE
...
```{r, mr-p3, out.width = "100%", message=F, warning=F, echo=F}
plot_data=subset(mr_data, param_name=="Total phosphorus" & mlid %in% c("4996570","4996550","4996555","4996566","4996630","4996540"))
plot_ly(plot_data) %>%
	add_trace(x=~as.Date(ActivityStartDate), y=~ResultMeasureValue, name=~mlid, type = "scatter", mode = "markers+lines") %>% 
	layout(
		xaxis = list(title = ""),
		...
		updatemenus = list(list(
			buttons= list(
				list(label = 'linear',
					method = 'update',
					args = list(list(visible = c(T)), list(yaxis = list(title = 'Total phosphorus (mg/L)', type = 'linear')))
				),
				list(label = 'log',
					method = 'update', 
					args = list(list(visible = c(T)), list(yaxis = list(title = 'Total phosphorus (mg/L)', type = 'log')))
				)
			)
		))
	) %>% 
...
```{r, mr-p2, out.width = "100%", message=F, warning=F, echo=F}
plot_data=subset(mr_data, param_name=="Total phosphorus" & mlid %in% c("4996570","4996550","4996555","4996566","4996630","4996540"))
levels(plot_data$mlid)=c("4996570","4996550","4996555","4996566","4996630","4996540")
plot_data=plot_data[order(factor(plot_data$mlid, levels = levels(plot_data$mlid))),]
plot_ly(plot_data) %>%
	add_trace(x=~mlid, y=~ResultMeasureValue, name=~ActivityStartDate, type = "scatter", mode = "markers+lines") %>% 
	layout(
		#legend = list(x = 0, y = 1),
		xaxis = list(title = "Upstream ---> downstream", categoryorder = "array", categoryarray = c("4996570","4996550","4996555","4996566","4996630","4996540")),
		yaxis=list(title="Total phosphorus (mg/L)"),
...
```{r, mr-n3, out.width = "100%", message=F, warning=F, echo=F}
plot_data=subset(mr_data, param_name=="Total nitrogen" & mlid %in% c("4996570","4996550","4996555","4996566","4996630","4996540"))
plot_ly(plot_data) %>%
	add_trace(x=~as.Date(ActivityStartDate), y=~ResultMeasureValue, name=~mlid, type = "scatter", mode = "markers+lines") %>% 
	layout(
		xaxis = list(title = ""),
		...
		updatemenus = list(list(
			buttons= list(
				list(label = 'linear',
					method = 'update',
					args = list(list(visible = c(T)), list(yaxis = list(title = 'Total nitrogen (mg/L)', type = 'linear')))
				),
				list(label = 'log',
					method = 'update', 
					args = list(list(visible = c(T)), list(yaxis = list(title = 'Total nitrogen (mg/L)', type = 'log')))
				)
			)
		))
	) %>% 
...
```
```{r, mr-n2, out.width = "100%", message=F, warning=F, echo=F}
plot_data=subset(mr_data, param_name=="Total nitrogen" & mlid %in% c("4996570","4996550","4996555","4996566","4996630","4996540"))
levels(plot_data$mlid)=c("4996570","4996550","4996555","4996566","4996630","4996540")
plot_data=plot_data[order(factor(plot_data$mlid, levels = levels(plot_data$mlid))),]
plot_ly(plot_data) %>%
...
### TDS
```{r, mr-TDS, out.width = "100%", message=F, warning=F, echo=F}
plot_ly(data=subset(mr_data, CharacteristicName=="Total dissolved solids")) %>%
	add_boxplot(x=~mlid, y=~ResultMeasureValue, name=~param_name) %>% 
	layout(
		legend = list(x = 0, y = 1),
		boxmode = "group",
		xaxis = list(title = "Upstream ---> downstream", categoryorder = "array", categoryarray = c("4996570","4996550","4996555","4996566","4996630","4996540")),
		yaxis=list(title="Total dissolved solids (mg/L)")
	) %>% 
	config(displaylogo = FALSE,
		modeBarButtonsToRemove = c(
			'sendDataToCloud',
...
### Phosphorus
```{r, ps-p3, out.width = "100%", message=F, warning=F, echo=F}
plot_data=subset(ps_data, param_name=="Total phosphorus" & mlid %in% c("4995260","4995251","4995252","4995255","4995256","4995258","4995210","4995230"))
plot_ly(plot_data) %>%
	add_trace(x=~as.Date(ActivityStartDate), y=~ResultMeasureValue, name=~mlid, type = "scatter", mode = "markers+lines") %>% 
	layout(
		xaxis = list(title = ""),
...
```{r, ps-p2, out.width = "100%", message=F, warning=F, echo=F}
plot_data=subset(ps_data, param_name=="Total phosphorus" & mlid %in% c("4995260","4995251","4995252","4995255","4995256","4995258","4995210","4995230"))
levels(plot_data$mlid)=c("4995260","4995251","4995252","4995255","4995256","4995258","4995210","4995230")
plot_data=plot_data[order(factor(plot_data$mlid, levels = levels(plot_data$mlid))),]
plot_ly(plot_data) %>%
	add_trace(x=~mlid, y=~ResultMeasureValue, name=~ActivityStartDate, type = "scatter", mode = "markers+lines") %>% 
	layout(
...
### Nitrogen
```{r, ps-n3, out.width = "100%", message=F, warning=F, echo=F}
plot_data=subset(ps_data, param_name=="Total nitrogen" & mlid %in% c("4995260","4995251","4995252","4995255","4995256","4995258","4995210","4995230"))
plot_ly(plot_data) %>%
	add_trace(x=~as.Date(ActivityStartDate), y=~ResultMeasureValue, name=~mlid, type = "scatter", mode = "markers+lines") %>% 
	layout(
		xaxis = list(title = ""),
...
```{r, ps-n2, out.width = "100%", message=F, warning=F, echo=F}
plot_data=subset(ps_data, param_name=="Total nitrogen" & mlid %in% c("4995260","4995251","4995252","4995255","4995256","4995258","4995210","4995230"))
levels(plot_data$mlid)=c("4995260","4995251","4995252","4995255","4995256","4995258","4995210","4995230")
plot_data=plot_data[order(factor(plot_data$mlid, levels = levels(plot_data$mlid))),]
plot_ly(plot_data) %>%
	add_trace(x=~mlid, y=~ResultMeasureValue, name=~ActivityStartDate, type = "scatter", mode = "markers+lines") %>% 
	layout(
		xaxis = list(title = "Upstream ---> downstream", categoryorder = "array", categoryarray = c("4995260","4995210","4995230")),
		yaxis=list(title="Total nitrogen (mg/L)"),
		updatemenus = list(list(
			buttons= list(
				list(label = 'linear',
...
```
```{r, ps-flow2, out.width = "100%", message=F, warning=F, echo=F}
plot_data=subset(ps_data, CharacteristicName=="Flow" & mlid %in% c("4995260","4995251","4995252","4995255","4995256","4995258","4995210","4995230"))
levels(plot_data$mlid)=c("4995260","4995251","4995252","4995255","4995256","4995258","4995210","4995230")
plot_data=plot_data[order(factor(plot_data$mlid, levels = levels(plot_data$mlid))),]
plot_ly(plot_data) %>%
	add_trace(x=~mlid, y=~ResultMeasureValue, name=~ActivityStartDate, type = "scatter", mode = "markers+lines") %>% 
...
### TDS
```{r, ps-TDS, out.width = "100%", message=F, warning=F, echo=F}
plot_ly(data=subset(ps_data, CharacteristicName=="Total dissolved solids")) %>%
	add_boxplot(x=~mlid, y=~ResultMeasureValue, name=~param_name) %>% 
	layout(
		legend = list(x = 0, y = 1),
		boxmode = "group",
...
```{r, ps-tds2, out.width = "100%", message=F, warning=F, echo=F}
plot_data=subset(ps_data, CharacteristicName=="Total dissolved solids" & mlid %in% c("4995260","4995251","4995252","4995255","4995256","4995258","4995210","4995230"))
levels(plot_data$mlid)=c("4995260","4995251","4995252","4995255","4995256","4995258","4995210","4995230")
plot_data=plot_data[order(factor(plot_data$mlid, levels = levels(plot_data$mlid))),]
plot_ly(plot_data) %>%
	add_trace(x=~mlid, y=~ResultMeasureValue, name=~ActivityStartDate, type = "scatter", mode = "markers+lines") %>% 
