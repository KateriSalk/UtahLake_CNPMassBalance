...
trib_wq <- trib %>%
  ...
  filter(CharacteristicName %in% 
           c("Ammonia-nitrogen as N", "Nitrate as N", "Organic carbon",
...
trib_fac_wq <- trib_fac_wq %>%
  ...
  mutate(Variable_summary = case_when(Variable == "Carbonate_Total" ~ "CO3.t_mgL",
                                       Variable == "Dissolved oxygen (DO)_Total" ~ "DO_mgL",
                                       Variable == "Inorganic nitrogen (nitrate and nitrite)_Dissolved" ~ "NO23_mgL",
                                       Variable == "Ammonia-nitrogen_Total" ~ "NH3.t_mgL",
                                       Variable == "Phosphate-phosphorus_Dissolved" ~ "TDP_mgL",
                                       Variable == "Phosphate-phosphorus_Total" ~ "TP_mgL",
                                       Variable == "Biochemical oxygen demand, standard conditions_Total" ~ "BOD_mgL",
                                       Variable == "Ammonia and ammonium_Dissolved" ~ "NH3.d_mgL",
                                       Variable == "Carbonate_Dissolved" ~ "CO3.d_mgL",
                                       Variable == "Kjeldahl nitrogen_Dissolved" ~ "TKN.d_mgL",
                                       Variable == "Kjeldahl nitrogen_Total" ~ "TKN.t_mgL",
                                       Variable == "Nitrate_Dissolved" ~ "NO3_mgL",
                                       Variable == "Nitrogen, mixed forms (NH3), (NH4), organic, (NO2) and (NO3)_Dissolved" ~ "MixedN.d_mgL",
                                       Variable == "Nitrogen, mixed forms (NH3), (NH4), organic, (NO2) and (NO3)_Total" ~ "MixedN.t_mgL",
                                       Variable == "Organic Nitrogen_Dissolved" ~ "DON_mgL",
                                       Variable == "Organic Nitrogen_Total" ~ "TON_mgL",
                                       Variable == "Phosphorus_Dissolved" ~ "TDP_mgL",
                                       Variable == "Phosphorus_Total" ~ "TP_mgL",
                                       Variable == "Organic carbon_Total" ~ "TOC_mgL",
                                       Variable == "Inorganic nitrogen (nitrate and nitrite)_Total" ~ "NO23.t_mgL",
                                       Variable == "Dissolved oxygen (DO)_NA" ~ "DO_mgL",
                                       Variable == "Nitrite_Dissolved" ~ "NO2.d_mgL",
                                       Variable == "Orthophosphate_Dissolved" ~ "PO4.d_mgL",
                                       Variable == "Ammonia-nitrogen as N_Dissolved" ~ "NH3.d_mgL",
                                       Variable == "Nitrate as N_Dissolved" ~ "NO3.d_mgL",
                                       Variable == "Organic carbon_Dissolved" ~ "DOC_mgL",
                                       Variable == "Ammonium_Total" ~ "NH3.t_mgL",
                                       Variable == "Dissolved oxygen (DO)_Dissolved" ~ "DO_mgL",
                                       Variable == "Inorganic carbon_Dissolved" ~ "DIC_mgL",
                                       Variable == "Nitrate_Total" ~ "NO3.t_mgL",
                                       Variable == "Nitrogen_Total" ~ "TN_mgL",
                                       Variable == "Phosphorus_NA" ~ "P_NA",
                                       Variable == "Ammonia-nitrogen_Dissolved" ~ "NH3.d_mgL",
                                       Variable == "Chlorophyll a, uncorrected for pheophytin_Total" ~ "Chla_uncorrected_ugL",
                                       Variable == "Nitrite_Total" ~ "NO2.t_mgL",
                                       Variable == "Nitrogen_Dissolved" ~ "TDN_mgL",
                                       Variable == "Chlorophyll a_Total" ~ "Chla_ugL",
                                       Variable == "Orthophosphate_Total" ~ "PO4.t_mgL",
                                       Variable == "Total Kjeldahl nitrogen_Total" ~ "TKN.t_mgL")) %>%
  group_by(MonitoringLocationIdentifier, ActivityStartDate, OrganizationIdentifier,
           ...
           LatitudeMeasure, LongitudeMeasure, Month, Year, Variable_summary, 
           ResultStatusIdentifier) %>%
  summarise(ResultMeasureValue = mean(ResultMeasureValue, na.rm = TRUE)) %>%
  pivot_wider(names_from = Variable_summary, values_from = ResultMeasureValue)
...
summary(trib_fac_sites_intersect_downstream)
