...
```{r, site-read-map}
ul_sites=wqTools::readWQP(type='sites', bBox=ul_bbox, siteType=c("Stream","Wetland"), sampleMedia="Water") #Connection to WQP occasionally times out, function tries connection up to 10 times
...
```{r, read-wqp-data}
ul_nr=wqTools::readWQP(type='narrowresult', bBox=ul_bbox, siteType=c("Stream","Wetland"), sampleMedia="Water", print=F)
...
```{r, subset-cols}
cols_keep=c(
	 "ActivityStartDate","ActivityStartTime.Time","OrganizationIdentifier","OrganizationFormalName","MonitoringLocationIdentifier","MonitoringLocationName","MonitoringLocationTypeName",  
	...
	"EstimatedQuantitationLimit","LowerQuantitationLimit","LowerReportingLimit","MethodDetectionLevel","MethodDetectionLevelUnit",  
	"UpperQuantitationLimit","EstimatedQuantitationLimitUnit",  
	"LowerQuantitationLimitUnit","LowerReportingLimitUnit","UpperQuantitationLimitUnit",   
	
	###Additional methods-related columns
	"ResultAnalyticalMethod.MethodIdentifier", "ResultAnalyticalMethod.MethodIdentifierContext","ResultAnalyticalMethod.MethodName", "LaboratoryName","MethodDescriptionText","SampleCollectionMethod.MethodName"
	)
```
...
```{r, check-unique}
check_data=ul_data[,c("MonitoringLocationIdentifier","SampleDepthValue","RelativeDepth","CharacteristicName","ResultSampleFractionText","ActivityStartDate", "ActivityStartTime.Time")]
...
```{r, id-non-unique}
result_count_data=ul_data[,c("MonitoringLocationIdentifier","SampleDepthValue","RelativeDepth","ActivityStartDate", "ActivityStartTime.Time","CharacteristicName","ResultSampleFractionText","ResultMeasureValue")]
result_count_data=lapply(result_count_data, addNA)
result_count=aggregate(ResultMeasureValue~MonitoringLocationIdentifier+ActivityStartDate+SampleDepthValue+RelativeDepth+CharacteristicName+ResultSampleFractionText, result_count_data, FUN='length')
