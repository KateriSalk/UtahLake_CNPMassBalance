...
```{r, write-raw}
write.csv(file=paste0("ul_wqpspringdata_raw_",Sys.Date(),".csv"), ul_data, row.names=F)
```
...
```{r, write-processed}
write.csv(file=paste0("ul_wqpspringdata_processed_",Sys.Date(),".csv"), ul_data, row.names=F)
```
